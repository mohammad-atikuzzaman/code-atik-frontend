...
const App = () => {
  ...
  const handleGenerate = async () => {
    ...
    const res = await axios.post("https://codeatik-agent-server.onrender.com/api/generate", {
      prompt,
    });
  ...
  <main className="container mx-auto px-6 py-10">
    <div className="grid lg:grid-cols-3 gap-8 min-h-[calc(100vh-10rem)]">
      
      {/* Input Panel */}
      <section className="space-y-6">
        <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 shadow-lg">
...
• A blog site with a clean layout`}
            ...
            className="min-h-[200px] bg-gray-800/60 border-gray-600 text-white placeholder-gray-400 resize-none rounded-md"
          />
