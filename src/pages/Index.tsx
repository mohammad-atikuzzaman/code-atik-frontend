...
import { ArrowRight, Code, Zap, Sparkles, Download, Palette, Globe, Monitor, Smartphone, Tablet, Github, Twitter, Linkedin, Heart } from 'lucide-react';
          ...
          <div className={`transition-all duration-1000 delay-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8 md:p-12 text-center hover:border-purple-500/50 transition-all duration-500">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
                Dedicated to creating innovative AI-powered tools that make web development accessible to everyone. 
                Combining cutting-edge artificial intelligence with modern web technologies to transform ideas into reality.
              </p>
              
              <div className="flex justify-center space-x-6">
                <a href="#" className="p-3 bg-gray-800/50 rounded-full hover:bg-purple-600/20 transition-colors duration-300 hover:scale-110 transform">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 leading-relaxed mb-6 max-w-md">
                Transform your ideas into stunning websites instantly with our AI-powered code assistant. 
                Build beautiful, responsive designs with HTML, CSS, Tailwind, and JavaScript.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/app" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">
                    Launch App
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <a href="#modes" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">
                    Device Modes
                  </a>
                </li>
                <li>
                  <a href="#developer" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">
                    About Developer
                  </a>
                </li>
              </ul>
