...
import { Download, Folder, Globe, MoreVertical, ExternalLink } from "lucide-react";
...
const Sites = () => {
  ...
  useEffect(() => {
    axios(`${import.meta.env.VITE_API_URL}/api/total-sites`, {
    ...
    <div className="min-h-screen text-white p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Manage and preview your generated websites</p>
        </div>
